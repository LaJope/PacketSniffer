...
Application::Application(std::unique_ptr<ps::IPacketReader> reader, std::unique_ptr<ps::IPacketWriter> writer)
...
int Application::start()
{
    ...
    {
        LOG_ERROR("Either Reader or Writer (or both) is not initialized for PacketSniffer. Aborting...");
        return 1;
    }
